    ...
    ;(async () => {
      try {
        const response = await fetch('/api/map/getDuration', {
          ...
          body: JSON.stringify({
            pickupCoordinates: `${pickupCoordinates.features[0]?.center[0]},${pickupCoordinates.features[0]?.center[1]}`,
            dropoffCoordinates: `${dropoffCoordinates.features[0]?.center[0]},${dropoffCoordinates.features[0]?.center[1]}`,
          }),
        })
